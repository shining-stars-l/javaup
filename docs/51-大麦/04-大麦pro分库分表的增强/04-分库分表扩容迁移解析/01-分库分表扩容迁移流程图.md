...
title: "分库分表扩容迁移流程图：虚拟分片扩容流程、Mermaid 时序图、数据迁移与清理流程详解"
sidebar_label: "分库分表扩容迁移流程图"
pagination_label: "分库分表扩容迁移流程图"
sidebar_class_name: has-upgrade-badge
description: "通过多幅 Mermaid 流程图、时序图和分配图，完整展示虚拟分片扩容迁移的执行流程，包括单库迁移、单表迁移、数据迁移与清理、路由表更新与缓存刷新、异常回滚以及扩容前后虚拟分片到物理表的分配关系。内容进一步围绕分库分表扩容迁移流程图、虚拟分片扩容流程、Mermaid 时序图、ShardingExpansionServ…"
