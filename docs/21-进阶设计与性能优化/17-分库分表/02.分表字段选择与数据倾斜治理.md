---
slug: /architecture/sharding/shard-key-selection
title: "分表字段选择与数据倾斜治理：ShardingKey、基因法、订单分表、核心原理、实现机制详解"
sidebar_label: "分表字段选择与数据倾斜治理"
pagination_label: "分表字段选择与数据倾斜治理"
description: "ShardingKey高散列性/高频查询/低更新原则;买家ID优于卖家ID避免大商家数据倾斜;基因法订单号携带买家ID分片信息;数据迁移与冷热分离治理倾斜问题。内容进一步围绕分表字段、订单分表等关键主题展开。通过原理拆解、实现步骤与适用场景说明相关方案如何落地。同时补充常见问题、排查思路、项目实践建议与技术面试要点。"
keywords: ["分表字段", "ShardingKey", "数据倾斜", "基因法", "订单分表"]
---
# 分表字段选择与数据倾斜治理
