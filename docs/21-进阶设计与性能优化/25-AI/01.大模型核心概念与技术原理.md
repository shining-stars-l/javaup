...
title: "大模型核心概念与技术原理：LLM、大语言模型、Transformer、注意力机制、Prompt详解"
sidebar_label: "大模型核心概念与技术原理"
pagination_label: "大模型核心概念与技术原理"
description: "LLM大语言模型参数规模从百万到万亿;Transformer架构自注意力机制与位置编码;预训练与微调两阶段训练过程;Prompt工程与Token计算基础概念。内容进一步围绕LLM、大语言模型、Transformer、注意力机制、Prompt等关键主题展开。通过原理拆解、实现步骤与适用场景说明相关方案如何落地。"
keywords: ["LLM", "大语言模型", "Transformer", "注意力机制", "Prompt"]
---
