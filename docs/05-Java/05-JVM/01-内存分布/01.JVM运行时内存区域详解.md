...
<img src="/img/Java/JVM/JVM虚拟机结构.png" width="100%" />
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 450">
  ...
  <!-- 主栈框架 -->
  <rect x="50" y="30" width="500" height="390" rx="20" fill="#1e7e8c" stroke="#155660" strokeWidth="3"/>
  <text x="300" y="20" fontSize="20" fontWeight="bold" textAnchor="middle" fill="#333">栈</text>
  
  <!-- 栈帧1 -->
  <rect x="80" y="60" width="440" height="280" rx="15" fill="#e09856" stroke="#b87844" strokeWidth="2"/>
  <text x="300" y="85" fontSize="18" fontWeight="bold" textAnchor="middle" fill="#fff">栈帧</text>
  
  <!-- 局部变量表 -->
  <rect x="110" y="100" width="360" height="45" rx="10" fill="#f5f5dc" stroke="#d3d3c3" strokeWidth="2"/>
  <text x="290" y="128" fontSize="16" textAnchor="middle" fill="#333">局部变量表</text>
  
  <!-- 操作数栈 -->
  <rect x="110" y="160" width="360" height="45" rx="10" fill="#f5f5dc" stroke="#d3d3c3" strokeWidth="2"/>
  <text x="290" y="188" fontSize="16" textAnchor="middle" fill="#333">操作数栈</text>
  
  <!-- 动态链接 -->
  <rect x="110" y="220" width="360" height="45" rx="10" fill="#f5f5dc" stroke="#d3d3c3" strokeWidth="2"/>
  <text x="290" y="248" fontSize="16" textAnchor="middle" fill="#333">动态链接</text>
  
  <!-- 方法返回地址 -->
  <rect x="110" y="280" width="360" height="45" rx="10" fill="#f5f5dc" stroke="#d3d3c3" strokeWidth="2"/>
  <text x="290" y="308" fontSize="16" textAnchor="middle" fill="#333">方法返回地址</text>
  
  <!-- 省略号 -->
  <text x="290" y="360" fontSize="24" fontWeight="bold" textAnchor="middle" fill="#333">⋮</text>
  
  <!-- 栈帧2 -->
  <rect x="80" y="370" width="440" height="40" rx="15" fill="#e09856" stroke="#b87844" strokeWidth="2"/>
  <text x="300" y="395" fontSize="16" textAnchor="middle" fill="#fff">栈帧</text>
</svg>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 700 400">
  ...
  <!-- 局部变量表 -->
  <g>
    <text x="65" y="30" fontSize="18" fontWeight="bold" fill="#333">局部变量表</text>
    <rect x="30" y="45" width="100" height="40" rx="5" fill="#d0e8f2" stroke="#7fb3d5" strokeWidth="2"/>
    <text x="80" y="70" fontSize="14" textAnchor="middle" fill="#333">int</text>
    
    <rect x="30" y="90" width="100" height="40" rx="5" fill="#d0e8f2" stroke="#7fb3d5" strokeWidth="2"/>
    <text x="80" y="115" fontSize="14" textAnchor="middle" fill="#333">short</text>
    
    <rect x="30" y="135" width="100" height="40" rx="5" fill="#d0e8f2" stroke="#7fb3d5" strokeWidth="2"/>
    <text x="80" y="160" fontSize="14" textAnchor="middle" fill="#333">double</text>
    
    <rect x="30" y="180" width="100" height="40" rx="5" fill="#d0e8f2" stroke="#7fb3d5" strokeWidth="2"/>
    <text x="80" y="205" fontSize="14" textAnchor="middle" fill="#333">float</text>
    
    <rect x="30" y="225" width="100" height="40" rx="5" fill="#d0e8f2" stroke="#7fb3d5" strokeWidth="2"/>
    <text x="80" y="250" fontSize="14" textAnchor="middle" fill="#333">char</text>
    
    <rect x="30" y="270" width="100" height="40" rx="5" fill="#d0e8f2" stroke="#7fb3d5" strokeWidth="2"/>
    <text x="80" y="295" fontSize="14" textAnchor="middle" fill="#333">......</text>
    
    <rect x="30" y="315" width="100" height="40" rx="5" fill="#d0e8f2" stroke="#7fb3d5" strokeWidth="2"/>
    <text x="80" y="340" fontSize="14" textAnchor="middle" fill="#333">reference</text>
  </g>
  
  <!-- 箭头指向堆 -->
  <path d="M 130 335 Q 200 300 270 280" fill="none" stroke="#333" strokeWidth="2" markerEnd="url(#arrowhead)"/>
  ...
  <!-- 堆区域 -->
  <g>
    <rect x="270" y="50" width="400" height="180" rx="15" fill="#fff8dc" stroke="#daa520" strokeWidth="3"/>
    <text x="470" y="35" fontSize="18" fontWeight="bold" textAnchor="middle" fill="#333">堆</text>
    
    <!-- 对象实例数据 -->
    <rect x="290" y="70" width="360" height="70" rx="10" fill="#fff" stroke="#ccc" strokeWidth="2"/>
    <text x="470" y="110" fontSize="15" fontWeight="bold" textAnchor="middle" fill="#333">对象实例数据（对象信息）</text>
    
    <!-- 箭头指向方法区 -->
    <path d="M 470 140 L 470 170" fill="none" stroke="#333" strokeWidth="2" markerEnd="url(#arrowhead)"/>
    <text x="500" y="160" fontSize="13" fill="#666">到对象类型数据的指针</text>
  </g>
  
  <!-- 方法区 -->
  <g>
    <rect x="270" y="260" width="400" height="110" rx="15" fill="#ffe4e1" stroke="#cd5c5c" strokeWidth="3"/>
    <text x="470" y="245" fontSize="18" fontWeight="bold" textAnchor="middle" fill="#333">方法区</text>
    
    <!-- 对象类型数据 -->
    <rect x="290" y="280" width="360" height="70" rx="10" fill="#fff" stroke="#ccc" strokeWidth="2"/>
    <text x="470" y="320" fontSize="15" fontWeight="bold" textAnchor="middle" fill="#4169e1">对象类型数据（类信息）</text>
  </g>
</svg>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 900 280">
  ...
  <!-- 标题 -->
  <text x="450" y="30" fontSize="20" fontWeight="bold" textAnchor="middle" fill="#333">年轻代 1/3　　　　　　　　　　　　　老年代 2/3</text>
  
  <!-- Eden区 -->
  <rect x="30" y="50" width="420" height="200" rx="10" fill="#fffacd" stroke="#daa520" strokeWidth="2"/>
  <text x="240" y="155" fontSize="18" fontWeight="bold" textAnchor="middle" fill="#333">Eden 80%</text>
  
  <!-- from区 -->
  <rect x="460" y="50" width="80" height="200" rx="10" fill="#d3d3d3" stroke="#808080" strokeWidth="2"/>
  <text x="500" y="130" fontSize="14" fontWeight="bold" textAnchor="middle" fill="#333">from</text>
  <text x="500" y="155" fontSize="14" fontWeight="bold" textAnchor="middle" fill="#333">10%</text>
  
  <!-- to区 -->
  <rect x="550" y="50" width="80" height="200" rx="10" fill="#90ee90" stroke="#228b22" strokeWidth="2"/>
  <text x="590" y="130" fontSize="14" fontWeight="bold" textAnchor="middle" fill="#333">to</text>
  <text x="590" y="155" fontSize="14" fontWeight="bold" textAnchor="middle" fill="#333">10%</text>
  
  <!-- 老年代 -->
  <rect x="640" y="50" width="230" height="200" rx="10" fill="#b0c4de" stroke="#4682b4" strokeWidth="2"/>
  <text x="755" y="155" fontSize="16" fontWeight="bold" textAnchor="middle" fill="#333">Old Generation</text>
  
  <!-- 分界线 -->
  <line x1="630" y1="45" x2="630" y2="255" stroke="#666" strokeWidth="3" strokeDasharray="5,5"/>
</svg>
...
graph LR
    ...
    B --> G[hashCode:25bit + age:4bit + 0:1bit + 01:2bit]
    C --> H[threadID:23bit + epoch:2bit + age:4bit + 1:1bit + 01:2bit]
    D --> I[栈中锁记录指针:30bit + 00:2bit]
    E --> J[重量级锁指针:30bit + 10:2bit]
    F --> K[空:30bit + 11:2bit]
...
| 字段 | 位数 | 说明 |
|------|------|------|
| hashCode | 25 | 对象的哈希码(懒加载生成) |
| age | 4 | 分代年龄(最大15) |
| biased_lock | 1 | 偏向锁标志 |
| lock | 2 | 锁状态标记 |
| thread | 23 | 持有偏向锁的线程ID |
| epoch | 2 | 偏向时间戳 |

#### 类型指针(Class Metadata Address)

指向方法区中该对象所属类的元数据结构(instanceKlass):
...
public class CourseManager {
    ...
    public static void main(String[] args) {
        // 创建两个课程对象
        Course javaCourse = new Course("Java核心技术", 199.0);
        Course pythonCourse = new Course("Python数据分析", 299.0);
        
        // 内存布局分析:
        // 1. 方法区: 创建Course类的instanceKlass(仅一份)
        //    - 包含方法表: Course构造函数、getter/setter等
        //    - 包含字段定义: String name, double price
        //    - 包含常量池引用
        
        // 2. 堆内存: 创建两个instanceOopDesc
        //    javaCourse对象:
        //      对象头 -> Mark Word(hashCode,age,lock等)
        //      对象头 -> Klass指针(指向Course的instanceKlass)
        //      实例数据 -> name="Java核心技术"
        //      实例数据 -> price=199.0
        //      对齐填充 -> 补齐到8字节倍数
        
        //    pythonCourse对象:
        //      对象头 -> Mark Word(与javaCourse不同)
        //      对象头 -> Klass指针(与javaCourse指向同一个instanceKlass)
        //      实例数据 -> name="Python数据分析"
        //      实例数据 -> price=299.0
        //      对齐填充 -> 补齐到8字节倍数
    }
}
...
实例数据存储对象的实际字段值,布局顺序遵循以下规则:

1. 相同宽度的字段分配在一起(long/double、int/float、short/char、byte/boolean、引用类型)
2. 父类字段在子类字段之前
3. 可通过`-XX:FieldsAllocationStyle`参数调整

```java
// 智能家居设备管理系统
public class SmartDevice {
    // 字段内存布局示例
    private boolean isOnline;      // 1字节
    private byte signalStrength;   // 1字节
    private short batteryLevel;    // 2字节
    private int deviceId;          // 4字节
    private float temperature;     // 4字节
    private long lastUpdateTime;   // 8字节
    private String deviceName;     // 引用类型(4字节或8字节)
    
    // 实际内存布局(HotSpot优化后):
    // 1. 对象头(8字节 Mark Word + 4字节 Klass指针 = 12字节,压缩指针开启时)
    // 2. long lastUpdateTime(8字节) - 优先排列8字节字段
    // 3. int deviceId(4字节)
    // 4. float temperature(4字节)
    // 5. short batteryLevel(2字节)
    // 6. boolean isOnline(1字节)
    // 7. byte signalStrength(1字节)
    // 8. String deviceName引用(4字节,压缩指针)
    // 9. 对齐填充(补齐到8的倍数)
}
```
...
JVM要求对象起始地址必须是8字节的整数倍,对齐填充会在对象末尾添加额外字节以满足此要求。
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 550">
  ...
  <!-- 箭号1: reference指向句柄池 -->
  <path d="M 130 335 Q 200 300 270 250" fill="none" stroke="#333" strokeWidth="2.5" markerEnd="url(#arrowhead)"/>
  ...
  <!-- 堆区域 -->
  <g>
    <rect x="240" y="50" width="530" height="380" rx="15" fill="#fff8dc" stroke="#daa520" strokeWidth="3"/>
    <text x="505" y="35" fontSize="18" fontWeight="bold" textAnchor="middle" fill="#333">堆</text>
    
    <!-- 句柄池 -->
    <g>
      <text x="360" y="85" fontSize="16" fontWeight="bold" textAnchor="middle" fill="#666">句柄池</text>
      <rect x="270" y="95" width="180" height="120" rx="10" fill="#fff" stroke="#999" strokeWidth="2"/>
      
      <!-- 句柄内容 -->
      <text x="360" y="125" fontSize="14" textAnchor="middle" fill="#333">到对象实例数据的指针</text>
      <text x="360" y="175" fontSize="14" textAnchor="middle" fill="#333">到对象类型数据的指针</text>
    </g>
    
    <!-- 实例池 -->
    <g>
      <text x="610" y="85" fontSize="16" fontWeight="bold" textAnchor="middle" fill="#666">实例池</text>
      <rect x="490" y="95" width="240" height="120" rx="10" fill="#e6f3ff" stroke="#4da6ff" strokeWidth="2"/>
      <text x="610" y="160" fontSize="15" fontWeight="bold" textAnchor="middle" fill="#333">对象实例数据（对象信息）</text>
    </g>
    
    <!-- 箭号2: 句柄指向实例数据 -->
    <path d="M 450 140 L 490 140" fill="none" stroke="#333" strokeWidth="2.5" markerEnd="url(#arrowhead)"/>
  </g>
  
  <!-- 方法区 -->
  <g>
    <rect x="240" y="280" width="530" height="130" rx="15" fill="#ffe4e1" stroke="#cd5c5c" strokeWidth="3"/>
    <text x="505" y="265" fontSize="18" fontWeight="bold" textAnchor="middle" fill="#333">方法区</text>
    
    <!-- 对象类型数据 -->
    <rect x="270" y="300" width="470" height="90" rx="10" fill="#fff" stroke="#ccc" strokeWidth="2"/>
    <text x="505" y="355" fontSize="15" fontWeight="bold" textAnchor="middle" fill="#4169e1">对象类型数据（类信息）</text>
  </g>
  
  <!-- 箭号3: 句柄指向类型数据 -->
  <path d="M 405 215 Q 455 250 505 300" fill="none" stroke="#333" strokeWidth="2.5" markerEnd="url(#arrowhead)"/>
</svg>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 480">
  ...
  <!-- 箭号1: reference直接指向对象实例 -->
  <path d="M 130 335 Q 250 260 370 180" fill="none" stroke="#333" strokeWidth="2.5" markerEnd="url(#arrowhead2)"/>
  ...
  <!-- 堆区域 -->
  <g>
    <rect x="240" y="50" width="530" height="250" rx="15" fill="#fff8dc" stroke="#daa520" strokeWidth="3"/>
    <text x="505" y="35" fontSize="18" fontWeight="bold" textAnchor="middle" fill="#333">堆</text>
    
    <!-- 对象实例数据 -->
    <g>
      <rect x="270" y="70" width="470" height="120" rx="10" fill="#e6f3ff" stroke="#4da6ff" strokeWidth="2"/>
      <text x="505" y="135" fontSize="15" fontWeight="bold" textAnchor="middle" fill="#333">对象实例数据（对象信息）</text>
    </g>
    
    <!-- 箭号2: 对象实例指向类型数据 -->
    <path d="M 505 190 L 505 240" fill="none" stroke="#333" strokeWidth="2.5" markerEnd="url(#arrowhead2)"/>
    <text x="540" y="220" fontSize="13" fill="#666">到对象类型数据的指针</text>
  </g>
  
  <!-- 方法区 -->
  <g>
    <rect x="240" y="330" width="530" height="130" rx="15" fill="#ffe4e1" stroke="#cd5c5c" strokeWidth="3"/>
    <text x="505" y="315" fontSize="18" fontWeight="bold" textAnchor="middle" fill="#333">方法区</text>
    
    <!-- 对象类型数据 -->
    <rect x="270" y="350" width="470" height="90" rx="10" fill="#fff" stroke="#ccc" strokeWidth="2"/>
    <text x="505" y="405" fontSize="15" fontWeight="bold" textAnchor="middle" fill="#4169e1">对象类型数据（类信息）</text>
  </g>
</svg>
