...
description: "提供super agent 项目所需中间件的Docker安装教程，涵盖MySQL、PostgresSql、Redis、MinIO、Zookeeper、Kafka、Elasticsearch、Kibana的镜像拉取与容器启动。"
...
![](/img/super-agent/项目启动讲解/minio界面.png)
