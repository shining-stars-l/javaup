...
title: "流式文本提取与输出控制：extractTextChunk、extractStreamingText详解"
sidebar_label: "流式文本提取与输出控制"
pagination_label: "流式文本提取与输出控制"
description: "详细讲解 extractTextChunk 和 extractStreamingText 两个方法，解析 ReactAgent 输出流中不同类型的 NodeOutput 是如何被筛选和提取为用户可见文本的。内容进一步围绕StreamingOutput、OutputType、AGENT_MODEL_STREAMING、…"
