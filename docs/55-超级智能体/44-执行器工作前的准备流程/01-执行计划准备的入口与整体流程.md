...
title: "执行计划准备的入口与整体流程：prepareExecutionPlan、会话记忆、问题改写详解"
sidebar_label: "执行计划准备的入口与整体流程"
pagination_label: "执行计划准备的入口与整体流程"
description: "讲解 prepareExecutionPlan 方法的入口和整体流程，包括会话记忆装载、问题改写、文档路由、执行模式判定等核心步骤。内容进一步围绕ChatPreparationOrchestrator、执行计划等关键主题展开。通过原理拆解、实现步骤与适用场景说明相关方案如何落地。同时补充常见问题、排查思路、项目实践建…"
