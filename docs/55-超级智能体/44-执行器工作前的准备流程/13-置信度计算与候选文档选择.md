...
title: "置信度计算与候选文档选择：路由状态、selectAutoCandidates、fallback兜底详解"
sidebar_label: "置信度计算与候选文档选择"
pagination_label: "置信度计算与候选文档选择"
description: "讲解 route 方法的置信度计算、路由状态判断、原因说明生成，以及回到 prepare 方法的候选文档选择逻辑（selectAutoCandidates）。内容进一步围绕fallback兜底等关键主题展开。通过原理拆解、实现步骤与适用场景说明相关方案如何落地。同时补充常见问题、排查思路、项目实践建议与技术面试要点。"
