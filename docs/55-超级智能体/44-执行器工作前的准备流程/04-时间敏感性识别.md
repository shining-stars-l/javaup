...
title: "时间敏感性识别：TimeSensitiveQueryHelper、日期锚定、最新信息识别详解"
sidebar_label: "时间敏感性识别"
pagination_label: "时间敏感性识别"
description: "详细讲解 TimeSensitiveQueryHelper 的两个核心方法 requiresCurrentDateAnchoring 和 requiresFreshSearch，包括关键词列表设计、判断逻辑与执行流程。内容进一步围绕时间敏感性、日期锚定、最新信息识别等关键主题展开。通过原理拆解、实现步骤与适用场景说明…"
