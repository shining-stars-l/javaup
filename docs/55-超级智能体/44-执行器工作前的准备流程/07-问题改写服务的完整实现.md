...
title: "问题改写服务的完整实现：ChatQueryRewriteService、Query Rewrite详解"
sidebar_label: "问题改写服务的完整实现"
pagination_label: "问题改写服务的完整实现"
description: "深入讲解 ChatQueryRewriteService 的问题改写实现，包括改写判断逻辑、模型调用、结果解析、规则兜底和子问题拆分机制。内容进一步围绕Query Rewrite、检索优化等关键主题展开。通过原理拆解、实现步骤与适用场景说明相关方案如何落地。同时补充常见问题、排查思路、项目实践建议与技术面试要点。"
