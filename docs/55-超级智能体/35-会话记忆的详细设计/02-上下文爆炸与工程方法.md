...
rectangle "上下文过长\nContext Overflow" as Root #DBEAFE

rectangle "中毒\nPoisoning" as PoisonHead #FECACA
rectangle "错误信息进入上下文" as Poison1 #FFF1F2
rectangle "后续推理基于错误前提" as Poison2 #FFFFFF

rectangle "分散\nDistraction" as DistractHead #BFDBFE
rectangle "无关信息过多" as Distract1 #EFF6FF
rectangle "重要指令被淹没" as Distract2 #FFFFFF

rectangle "混乱\nConfusion" as ConfuseHead #BBF7D0
rectangle "工具 / 选项过多" as Confuse1 #F0FDF4
rectangle "决策质量下降" as Confuse2 #FFFFFF

rectangle "冲突\nClash" as ClashHead #FDE68A
rectangle "矛盾信息共存" as Clash1 #FFFBEB
rectangle "推理结果混乱" as Clash2 #FFFFFF

PoisonHead -[hidden]right-> DistractHead
DistractHead -[hidden]right-> ConfuseHead
ConfuseHead -[hidden]right-> ClashHead

Poison1 -[hidden]right-> Distract1
Distract1 -[hidden]right-> Confuse1
Confuse1 -[hidden]right-> Clash1

Poison2 -[hidden]right-> Distract2
Distract2 -[hidden]right-> Confuse2
Confuse2 -[hidden]right-> Clash2

Root -down-> PoisonHead
Root -down-> DistractHead
Root -down-> ConfuseHead
Root -down-> ClashHead

PoisonHead -down-> Poison1
Poison1 -down-> Poison2

DistractHead -down-> Distract1
Distract1 -down-> Distract2

ConfuseHead -down-> Confuse1
Confuse1 -down-> Confuse2

ClashHead -down-> Clash1
Clash1 -down-> Clash2
@enduml
```
...
package "提示词工程\nPrompt Engineering" as PromptEng #FFF7ED {
  rectangle "关注点\n如何措辞" as pe1 #FFE7C2
  rectangle "作用域\nSystem Prompt + User Prompt" as pe2 #FFFFFF
  rectangle "目标\n让模型理解你的意图" as pe3 #FFFFFF
}

package "上下文工程\nContext Engineering" as ContextEng #EFF6FF {
  rectangle "关注点\n信息的取舍与编排" as ce1 #DBEAFE
  rectangle "作用域\n整个 Context 窗口" as ce2 #FFFFFF
  rectangle "目标\n让模型只看到恰到好处的信息" as ce3 #FFFFFF
}
...
rectangle "Write\n写入" as W #DBEAFE
rectangle "草稿板\nScratchpad" as W1 #EFF6FF
rectangle "长期记忆\nLong-term Memory" as W2 #FFFFFF
...
rectangle "Compress\n压缩" as C #FDE68A
rectangle "摘要压缩" as C1 #FFFBEB
rectangle "滑动窗口裁剪" as C2 #FFFFFF
rectangle "智能修剪" as C3 #FFFFFF

rectangle "Isolate\n隔离" as I #FBCFE8
rectangle "多智能体拆分" as I1 #FDF2F8
rectangle "沙盒执行" as I2 #FFFFFF
rectangle "状态分层" as I3 #FFFFFF
