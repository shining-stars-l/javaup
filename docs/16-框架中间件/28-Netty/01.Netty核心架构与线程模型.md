...
description: "Netty高性能异步事件驱动网络框架特性;Reactor模式与IO多路复用核心原理;单Reactor单线程/多线程/主从Reactor三种线程模型;EventLoopGroup配置与NioServerSocketChannel使用;主从Reactor连接处理与IO处理职责分离设计。"
