...
title: "Netty序列化与粘包拆包处理：Protobuf、解码器、核心原理、实现机制、源码分析详解"
sidebar_label: "Netty序列化与粘包拆包处理"
pagination_label: "Netty序列化与粘包拆包处理"
description: "Java/JSON/XML/Protobuf/Thrift序列化协议对比选择;TCP粘包拆包产生原因与解决方案;FixedLengthFrameDecoder定长解码;LineBasedFrameDecoder行分隔符解码;LengthFieldBasedFrameDecoder长度字段解码;自定义ByteToMes…"
keywords: ["序列化", "粘包拆包", "Protobuf", "LengthFieldBasedFrameDecoder", "解码器"]
---
# Netty序列化与粘包拆包处理
