...
description: "Java/JSON/XML/Protobuf/Thrift序列化协议对比选择;TCP粘包拆包产生原因与解决方案;FixedLengthFrameDecoder定长解码;LineBasedFrameDecoder行分隔符解码;LengthFieldBasedFrameDecoder长度字段解码;自定义ByteToMessageDecoder协议实现。"
