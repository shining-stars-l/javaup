...
title: "Netty零拷贝技术：DirectBuffer、CompositeByteBuf、FileRegion详解"
sidebar_label: "Netty零拷贝技术详解"
pagination_label: "Netty零拷贝技术详解"
description: "堆外内存DirectBuffer避免用户态内核态拷贝;CompositeByteBuf指针组合零拷贝合并;Unpooled.wrappedBuffer包装共享底层存储;ByteBuf.slice切分共享内存区域;FileRegion基于sendFile操作系统级零拷贝传输。内容进一步围绕零拷贝、DirectBuffe…"
