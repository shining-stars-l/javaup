...
title: "MyBatis延迟加载与关联查询：LazyLoading、CGLIB代理、fetchType详解"
sidebar_label: "MyBatis延迟加载与关联查询"
pagination_label: "MyBatis延迟加载与关联查询"
description: "延迟加载LazyLoading原理;CGLIB代理对象生成;lazyLoadingEnabled全局配置;aggressiveLazyLoading按需加载;fetchType属性控制;一对多/多对一关联查询优化;N+1查询问题解决。内容进一步围绕N+1问题等关键主题展开。通过原理拆解、实现步骤与适用场景说明相关方案…"
keywords: ["延迟加载", "LazyLoading", "CGLIB代理", "fetchType", "N+1问题"]
---
