...
title: "RocketMQ高级特性与事务消息：延时消息、时间轮、半消息、本地事务、核心原理、实现机制详解"
sidebar_label: "RocketMQ高级特性与事务消息"
pagination_label: "RocketMQ高级特性与事务消息"
description: "延时消息工作原理与时间轮实现机制;RocketMQ 4.x 18个延时级别与5.0任意时长延时;事务消息两阶段提交与本地事务原子性保障;订单超时取消/定时任务触发应用场景。内容进一步围绕半消息等关键主题展开。通过原理拆解、实现步骤与适用场景说明相关方案如何落地。同时补充常见问题、排查思路、项目实践建议与技术面试要点。"
