...
title: "SpringBoot启动原理：SpringApplication、spring.factories详解"
sidebar_label: "SpringBoot启动原理"
pagination_label: "SpringBoot启动原理"
description: "SpringApplication初始化流程;spring.factories SPI加载机制;ApplicationContextInitializer/ApplicationListener;run方法执行步骤;Environment环境装配;refresh刷新上下文;内嵌Tomcat启动;LaunchedURL…"
