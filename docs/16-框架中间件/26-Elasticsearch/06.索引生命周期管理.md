...
description: "ILM索引生命周期管理Hot/Warm/Cold/Frozen/Delete五阶段;Rollover索引滚动与min_age阶段流转;forcemerge/shrink/searchable_snapshot阶段动作;ILM策略配置与模板绑定实战;成本优化60%-80%与合规要求满足。"
