...
title: "String 类：String不可变、字符串常量池、StringBuilder、intern详解"
sidebar_label: "String 类详解"
pagination_label: "String 类详解"
description: "深入剖析String不可变性的实现原理与设计动机(常量池、安全性、线程安全、HashCode缓存);全面对比String、StringBuilder、StringBuffer的性能与适用场景;图解字符串常量池机制、new String()创建对象数量、intern()方法原理;讲解编译期与运行期的长度限制;介绍 JD…"
keywords: ["String不可变", "字符串常量池", "StringBuilder", "StringBuffer", "intern", "Compact String", "字符串拼接", "String Pool"]
---
