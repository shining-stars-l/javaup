...
title: "Java集合框架：Collection、Map、List、Set、ArrayList详解"
sidebar_label: "Java集合框架详解"
pagination_label: "Java集合框架详解"
description: "全面解析Java集合框架:Collection与Map两大体系结构、List/Set/Queue/Map四大接口特点对比、ArrayList/LinkedList/HashSet/TreeSet/HashMap等核心实现类的使用场景;通过详细的层次结构图和对比分析,帮助理解集合框架的设计原理与选型策略。"
keywords: ["集合框架", "Collection", "Map", "List", "Set", "ArrayList", "HashMap", "Java集合"]
---
...
> Queue接口的详细内容已拆分至独立文档，请参阅 [Queue接口详解](/java/collect/queue-interface)。
