...
title: "垃圾收集器：Serial、ParNew、Parallel Scavenge、CMS详解"
sidebar_label: "垃圾收集器详解"
pagination_label: "垃圾收集器详解"
description: "详解HotSpot主流垃圾收集器:新生代Serial/ParNew/Parallel Scavenge的工作原理;老年代Serial Old/Parallel Old/CMS的回收特点;分析收集器组合模式(Serial+Serial Old/ParNew+CMS/Parallel+Parallel Old);不同JD…"
keywords: ["垃圾收集器", "Serial", "ParNew", "Parallel Scavenge", "CMS", "Parallel Old"]
---
