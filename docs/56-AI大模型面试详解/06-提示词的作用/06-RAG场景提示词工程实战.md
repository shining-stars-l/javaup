---
slug: /ai-interview/prompt/rag-prompt-engineering
title: "RAG场景提示词工程实战：检索增强生成、知识库问答、提示词注入、引用标注、信息冲突详解"
sidebar_label: "RAG场景提示词工程实战"
pagination_label: "RAG场景提示词工程实战"
description: "RAG场景的提示词有独特的挑战：限定知识来源、处理信息冲突、要求引用标注、防止提示词注入。掌握这些专门技巧，打造可靠的知识库问答系统。内容进一步围绕检索增强生成、兜底策略、澄清机制等关键主题展开。通过原理拆解、实现步骤与适用场景说明相关方案如何落地。同时补充常见问题、排查思路、项目实践建议与技术面试要点。"
...
:::tip 实战项目推荐
RAG 提示词的关键是把问题、证据、引用约束和兜底策略组织清楚。超级 AI 智能体的 RAG 链路包含问题改写、知识路由、混合检索、重排序和回答生成，可以作为这篇内容的完整实战场景。
