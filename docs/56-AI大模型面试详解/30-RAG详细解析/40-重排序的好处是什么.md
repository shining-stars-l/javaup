---
slug: /ai-interview/rag/reranking
title: "重排序的好处是什么：Reranking、Cross-Encoder、Bi-Encoder详解"
sidebar_label: "重排序的好处是什么"
pagination_label: "重排序的好处是什么"
description: "混合检索召回了一堆候选文档，但排序未必精准。重排序用更强的模型对候选集逐一精细打分，把真正相关的内容推到最前面。内容进一步围绕Reranking、Cross-Encoder、Bi-Encoder、Reranker、RRF等关键主题展开。通过原理拆解、实现步骤与适用场景说明相关方案如何落地。同时补充常见问题、排查思路、…"
...
:::tip 实战项目推荐
重排序是超级 AI 智能体 RAG 链路中的重要提质环节：初始召回负责“找得全”，重排序负责“排得准”，再结合链路观测判断哪些片段真正支撑了回答。
