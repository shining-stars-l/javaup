...
title: "为什么要问题重写：问题改写、Query Rewrite、指代消解、HyDE、问题分解详解"
sidebar_label: "为什么要问题重写"
pagination_label: "为什么要问题重写"
description: "用户的提问千奇百怪，直接丢给向量库检索往往答非所问。问题改写就是在检索之前帮用户把话说清楚，本文从实际踩坑出发，拆解五种改写策略并给出Spring AI落地代码。内容进一步围绕Query Rewrite、指代消解、HyDE、问题分解、QueryTransformer等关键主题展开。通过原理拆解、实现步骤与适用场景说明…"
...
:::tip 实战项目推荐
问题改写是超级 AI 智能体会话链路里的关键阶段，项目会记录改写前后的问题，便于观察指代消解、语义补全和检索召回之间的关系。
