...
title: "大模型训练与微调技术全貌：预训练、SFT、RLHF、DPO、PPO、LoRA、QLoRA详解"
sidebar_label: "大模型训练与微调技术全貌"
pagination_label: "大模型训练与微调技术全貌"
description: "大模型训练全链路拆解：预训练到对齐的三阶段流程、Scaling Law与Chinchilla法则、微调方案对比（Full/LoRA/QLoRA）、后训练技术详解（RLHF/DPO/GRPO）、PPO与DPO的本质区别。内容进一步围绕SFT、Post-Training等关键主题展开。通过原理拆解、实现步骤与适用场景说明…"
...
:::tip 实战项目推荐
训练和微调解决的是“模型本身怎么变强”，超级 AI 智能体关注的是“拿到模型之后怎么做成可用产品”。项目里通过提示词、RAG、知识路由、评测和可观测性提升效果，适合补齐应用工程化视角。
