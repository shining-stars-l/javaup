...
title: "对话记忆系统设计：ChatMemory、短期记忆、长期记忆、持久化记忆、MySQL详解"
sidebar_label: "对话记忆系统设计"
pagination_label: "对话记忆系统设计"
description: "系统讲解AI对话记忆的设计与实现：短期记忆与长期记忆的区别、Spring AI的ChatMemory体系、基于MySQL的持久化存储，以及记忆管理的最佳实践。内容进一步围绕MessageWindowChatMemory、持久化记忆等关键主题展开。通过原理拆解、实现步骤与适用场景说明相关方案如何落地。"
...
:::tip 实战项目推荐
对话记忆不是简单把历史消息塞回上下文。超级 AI 智能体实现了会话记录、轮次详情和增量摘要等能力，可以帮助你理解短期记忆、长期记忆和容量治理如何落地。
