...
title: "开始第一个对话：Spring AI集成、DeepSeek模型、ChatClient调用详解"
sidebar_label: "开始第一个对话"
pagination_label: "开始第一个对话"
description: "第一个AI对话功能落地教程，覆盖Spring Boot集成Spring AI、DeepSeek模型依赖配置、ChatClient调用方式与Controller接口实现，完成端到端对话链路。内容进一步围绕Spring AI集成、对话请求封装、提示词输入、响应解析、Spring Boot AI等关键主题展开。"
keywords: ["Spring AI集成", "DeepSeek模型", "ChatClient调用", "Controller接口", "对话请求封装", "提示词输入", "响应解析", "Spring Boot AI"]
---
...
![进行对话：简单对话](/img/damai-ai/开始第一个对话/简单对话.png)
